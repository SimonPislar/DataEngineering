...
public class WordCount {
    ...
    /*
        @param Object key: The key of the input text
        @param Text value: The value of the input text
        @param Context context: The context of the input text
        @Brief: The map function takes the input text and tokenizes it into words. It then writes the word and the value 1 to the context.
     */
